...
export function NewClientForm({ onAddOrder, clients }: NewOrderFormProps) {
...
<div className=" ml-10 w-20/100">
    ...
    <div className="m-3 flex-col items-center justify-center rounded-xl bg-     [#12282d]/70 border border-[#3a5d65] w-full h-100 overflow-x-auto overflow-y-hidden">
      <h2 className="ml-10 text-xl text-white mt-5">Cliente</h2>
        <select onChange={(e) => setCid(Number(e.target.value))} className="rounded-lg bg-[#19373e] w-80/100 h-10/100 ml-10 mb-5 border border-[#3a5d65] text-white p-2">
