...
export const RegisterForm = ({ onSubmit, onEmailChange, onPasswordChange, email, password, error, loading }: RegisterFormProps) => {
    return (
        <div className="flex-col justify-center align-center border-2 border-[#3a5d65] rounded-3xl  w-100 h-100">
            ...
            <h1 className="text-2xl text-transparent bg-clip-text bg-linear-90 from-[#42C0DF] to-[#9dd5e2] font-bold">iRepair</h1>
             ...
             <h1 className="text-3xl text-transparent bg-clip-text bg-linear-90 from-[#42C0DF] to-[#9dd5e2] font-bold text-center">Cadastro</h1>
            ...
            <Link className="text-[#9dd5e2] hover:text-white" to="/login">
